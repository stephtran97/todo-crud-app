...
/* eslint-disable */
export class Icons {
  public static PlusIcon = (): JSX.Element => {
    return (
      <svg
  ...
  public static PenIcon = (): JSX.Element => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
  ...
  public static TrashBinIcon = (): JSX.Element => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
  ...
  public static TickIcon = (): JSX.Element => {
    return (
      <svg
        version="1.0"
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        >
          <path
            d="M11135 12761 c-11 -10 -141 -108 -290 -217 -1922 -1415 -3188 -2504
  ...
  public static CrossMarkIcon = (): JSX.Element => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  public static ExclamationMark = (): JSX.Element => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
  ...
  public static AllTodosMark = (): JSX.Element => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
  ...
  public static CompletedTodosMark = (): JSX.Element => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
  ...
  public static ActiveTodosMark = (): JSX.Element => {
    return (
      <svg
        fill="currentColor"
        version="1.1"
